                                            ...
                                            <div className={styles.form}>
                                                {
                                                    ...
                                                    <div className={styles.item}>
                                                        ...
                                                        <textarea placeholder="Cevabınız..." required={false} value={universite_temsilcilik_sureci_genel_bilgiler.question_1} onInput={(e)=>{
                                                    ...
                                                    <div className={styles.item}>
                                                        ...
                                                        <textarea placeholder="Cevabınız..." required={false}  value={universite_temsilcilik_sureci_genel_bilgiler.question_3} onInput={(e)=>{
                                                            set_universite_temsilcilik_sureci_genel_bilgiler({
                                                                ...universite_temsilcilik_sureci_genel_bilgiler,
                                                    ...
                                                    <div className={styles.item}>
                                                        ...
                                                        <textarea placeholder="Cevabınız..." required={false} value={universite_temsilcilik_sureci_genel_bilgiler.question_6} onInput={(e)=>{
                                                            set_universite_temsilcilik_sureci_genel_bilgiler({
                                                                ...universite_temsilcilik_sureci_genel_bilgiler,
