...
export default function Form(){
    ...
    const [steps,set_steps] = useState([
        ...
        {
            name: "Üniversite Temsilcilik Süreci Genel Bilgiler"
        }
    ]);
    ...
    const [universite_temsilcilik_sureci_genel_bilgiler,set_universite_temsilcilik_sureci_genel_bilgiler] = useState({
        question_1: "",
        question_2: "",
        question_3: "",
        question_4: "",
    ...
    const [universite_temsilcilik_sureci_genel_bilgiler_question_5_options,set_universite_temsilcilik_sureci_genel_bilgiler_question_5_options] = useState([
        {
            name: "1-2 Saat",
            key: "1-2",
            checked: false
    ...
    let handle_submit = (e) => {
        ...
        if(state==0){
            ...
            universite_temsilcilik_sureci_genel_bilgiler_handle();
        }else{
        }
    };
    ...
    let get_form_handle = () => {
        ...
        .then(data=>{
            ...
            if(data.success){
                ...
                if(data.university_representation_process_general_information){
                    set_universite_temsilcilik_sureci_genel_bilgiler(data.university_representation_process_general_information);

                    set_universite_temsilcilik_sureci_genel_bilgiler_question_5_options(universite_temsilcilik_sureci_genel_bilgiler_question_5_options.map((item,index)=>{
                        if(data.university_representation_process_general_information.question_5 == item.key){
                            return {
                                ...item,
                                checked: true
                            }
    ...
    let universite_temsilcilik_sureci_genel_bilgiler_handle = () => {
        set_loader(true);
        let question_2_data = [];

        universite_temsilcilik_sureci_genel_bilgiler_question_5_options.map(a=>{
            if(a.checked){
                question_2_data.push(a.key);
            }
        })

        FormService.university_representation_process_general_information_form(Cookies.get("ehs_user_token"),JSON.stringify({
            ...universite_temsilcilik_sureci_genel_bilgiler
    ...
    let mentorluk_sureci_ayrinti_bilgiler_form_handle = () => {
        ...
        set_loader(true);
        let body = {};
        console.log(universite_temsilcilik_sureci_genel_bilgiler_question_5_options);
        universite_temsilcilik_sureci_genel_bilgiler_question_5_options.map(a=>{
    ...
    useEffect(()=>{
        console.log("universite_temsilcilik_sureci_genel_bilgiler : ",universite_temsilcilik_sureci_genel_bilgiler)
    },[universite_temsilcilik_sureci_genel_bilgiler])
                                            ...
                                            <div className={styles.form}>
                                                {
                                                    ...
                                                    <div className={styles.item}>
                                                        ...
                                                        <textarea placeholder="Cevabınız..." required={true} value={universite_temsilcilik_sureci_genel_bilgiler.question_1} onInput={(e)=>{
                                                    ...
                                                    <div className={styles.item}>
                                                        ...
                                                        <textarea placeholder="Cevabınız..." required={true} value={universite_temsilcilik_sureci_genel_bilgiler.question_2} onInput={(e)=>{
                                                            set_universite_temsilcilik_sureci_genel_bilgiler({
                                                                ...universite_temsilcilik_sureci_genel_bilgiler,
                                                    ...
                                                    <div className={styles.item}>
                                                        <div className={styles.question}>
                                                            3.  Bu role nasıl katkı sağlayacağına dair düşüncüleriniz nelerdir?
                                                        </div>
                                                        <textarea placeholder="Cevabınız..." required={true}  value={universite_temsilcilik_sureci_genel_bilgiler.question_3} onInput={(e)=>{
                                                            set_universite_temsilcilik_sureci_genel_bilgiler({
                                                                ...universite_temsilcilik_sureci_genel_bilgiler,
                                                    ...
                                                    <div className={styles.item}>
                                                        ...
                                                        <textarea placeholder="Cevabınız..." required={true}  value={universite_temsilcilik_sureci_genel_bilgiler.question_4} onInput={(e)=>{
                                                            set_universite_temsilcilik_sureci_genel_bilgiler({
                                                                ...universite_temsilcilik_sureci_genel_bilgiler,
                                                    ...
                                                    <div className={styles.item+" "+(
                                                        error.code=="rol_saat_min_1"?
                                                        styles.error
                                                        :""
                                                    )} ref={mentorluk_basvuru_turu_ref}>
                                                        <div className={styles.question}>
                                                            5.  Haftalık olarak bu role ne kadar zaman ayırabilirsiniz?
                                                        </div>
                                                        <div className={styles.options}>
                                                            {
                                                                universite_temsilcilik_sureci_genel_bilgiler_question_5_options.map((option,index)=>{
                                                                    return (
                                                                        <div key={"mentorluk-sureci-1-"+index} className={styles.option} onClick={()=>{
                                                                            ...
                                                                            set_universite_temsilcilik_sureci_genel_bilgiler_question_5_options(universite_temsilcilik_sureci_genel_bilgiler_question_5_options.map((a,map_index)=>{
                                                                                if(index==map_index){
                                                                                    return {
                                                                                        ...a,
                                                                                        checked: !a.checked
                                                                            ...
                                                                            set_universite_temsilcilik_sureci_genel_bilgiler({
                                                                                ...universite_temsilcilik_sureci_genel_bilgiler,
                                                                                question_5: option.key
                                                                            })
                                                                        }}>
                                                                            <div className={styles.radio_item} name="lisans-ve-lisansüst-tez">
                                                    ...
                                                    <div className={styles.item}>
                                                        <div className={styles.question}>
                                                            6.  Eklemek istediğiniz herhangi bir ek bilgi veya yorum var mı?
                                                        </div>
                                                        <textarea placeholder="Cevabınız..." required={true} value={universite_temsilcilik_sureci_genel_bilgiler.question_6} onInput={(e)=>{
                                                            set_universite_temsilcilik_sureci_genel_bilgiler({
                                                                ...universite_temsilcilik_sureci_genel_bilgiler,
