            ...
            <div className={styles.column}>
                <div className={styles.card_body}>
                    ...
                    <div className={styles.card_bottom}>
                        <div className={styles.comment}>
                            <p className={styles.p}>
                                Energy Hack Space'in kurucu ortaklarından biri olarak, enerji sektörüne dair edindiğim bilgileri genç yeteneklerle paylaşmayı her zaman önemli buldum. Özellikle enerji alanında optimizasyon ve yapay zeka konularında çalışan öğrenci ve yeni mezunlarla gerçekleştirdiğim mentörlük seansları, benim için ayrı bir öneme sahip. Mentörlük yolculuğum Energy Hack Space öncesine de uzanıyor ve bu kısa süre zarfında birçok yeteneğe kılavuzluk ederek onların kariyer yollarını şekillendirmelerine katkıda bulundum. Energy Hack Space'deki görevim sayesinde, bu deneyimi daha geniş bir kitleye ulaştırma şansım oldu. Kendi mentee deneyimlerimden elde ettiğim içgörülerle, enerji sektöründeki geleceğin profesyonellerine rehberlik ediyorum. Bu süreçte hem bilgi ve deneyimlerimi paylaşma hem de yeni nesille birlikte öğrenme fırsatı buluyorum.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div className={styles.column}>
                <div className={styles.card_body}>
                    ...
                    <div className={styles.card_bottom}>
                        <div className={styles.comment}>
                            <p className={styles.p}>
                                Foton Türkiye IREC Platformu ve Energy Hack Space'in kurucu ortağı olarak, enerji sektöründe yenilikçi fikirlerin ve genç yeteneklerin teşvik edilmesini her zaman destekledim. Enerji alanında bir kariyer veya girişimci olmayı düşünenler için sağladığım mentörlük, bana sektördeki taze fikirleri ve inovatif yaklaşımları yakından gözlemleme şansı veriyor. EHS'nin mentörlük programları, sektöre adım atmaya kararlı gençleri deneyimli profesyonellerle bir araya getiriyor ve bu, hem mentörler için hem de mentee'ler için son derece değerli bir fırsat. Bu programların içinde yer almak, enerji sektöründeki gençleri motive etmek, onlara rehberlik etmek ve kariyerlerinin her aşamasında yanlarında olmak adına büyük bir ayrıcalık. EHS'nin mentörlük programlarına katılan her bireyin, enerji alanında katma değer yaratan, yenilikçi ve sürdürülebilir projelerde yer alacağına inanıyorum.
                            </p>
                        </div>
                    </div>
                </div>
