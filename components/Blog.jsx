...
function Blog() {
    const [checkbox_input, set_checkbox_input] = useState([]);
            ...
            <div className={styles.wrapper}>
                ...
                <div className={styles.right}>
                    <div className={styles.categories}>
                        ...
                        <div onClick={()=>{
                                    if(checkbox_input.includes("design")){
                                        set_checkbox_input(checkbox_input.filter(a=>{
                                            if(a=="design"){
                                                return false
                                            }return true
                                        }))
                                    }else{
                                        set_checkbox_input([...checkbox_input,"design"]);
                                    }
                                }} className={styles.category}>
                            <div className={styles.check_box}>
                                <div className={styles.checkbox_input+" "+(checkbox_input.includes("design")?styles.active:"")}>
                                    <div className={styles.checkbox_square+" "+(checkbox_input.includes("design")?styles.active:"")}>
                        ...
                        <div onClick={()=>{
                                    if(checkbox_input.includes("it-and-software")){
                                        set_checkbox_input(checkbox_input.filter(a=>{
                                            if(a=="it-and-software"){
                                                return false
                                            }return true
                                        }))
                                    }else{
                                        set_checkbox_input([...checkbox_input,"it-and-software"]);
                                    }
                                }} className={styles.category}>
                            <div className={styles.check_box}>
                                
                                <div className={styles.checkbox_input+" "+(checkbox_input.includes("it-and-software")?styles.active:"")}>
                                    <div className={styles.checkbox_square+" "+(checkbox_input.includes("it-and-software")?styles.active:"")}>
                        ...
                        <div onClick={()=>{
                                    if(checkbox_input.includes("development")){
                                        set_checkbox_input(checkbox_input.filter(a=>{
                                            if(a=="development"){
                                                return false
                                            }return true
                                        ...
                                        set_checkbox_input([...checkbox_input,"development"]);
                                    }
                                }} className={styles.category}>
                            <div className={styles.check_box}>
                                
                                <div className={styles.checkbox_input+" "+(checkbox_input.includes("development")?styles.active:"")}>
                                    <div className={styles.checkbox_square+" "+(checkbox_input.includes("development")?styles.active:"")}>
                        ...
                        <div onClick={()=>{
                                    if(checkbox_input.includes("marketing")){
                                        set_checkbox_input(checkbox_input.filter(a=>{
                                            if(a=="marketing"){
                                                return false
                                            }return true
                                        ...
                                        set_checkbox_input([...checkbox_input,"marketing"]);
                                    }
                                }} className={styles.category}>
                            <div className={styles.check_box}>
                                
                                <div className={styles.checkbox_input+" "+(checkbox_input.includes("marketing")?styles.active:"")}>
                                    <div className={styles.checkbox_square+" "+(checkbox_input.includes("marketing")?styles.active:"")}>
                        ...
                        <div onClick={()=>{
                                    if(checkbox_input.includes("business")){
                                        set_checkbox_input(checkbox_input.filter(a=>{
                                            if(a=="business"){
                                                return false
                                            }return true
                                        ...
                                        set_checkbox_input([...checkbox_input,"business"]);
                                    }
                                }} className={styles.category}>
                            <div className={styles.check_box}>
                                <div className={styles.checkbox_input+" "+(checkbox_input.includes("business")?styles.active:"")}>
                                    <div className={styles.checkbox_square+" "+(checkbox_input.includes("business")?styles.active:"")}>
